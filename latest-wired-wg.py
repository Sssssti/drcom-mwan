...
ADAPTERNUM = '\x04'
host_ip = '172.21.133.102'
IPDOG = '\x01'
host_name = 'PandoraBox-3'
PRIMARY_DNS = '172.16.10.35'
dhcp_server = '172.21.133.1'
...
keep_alive1_mod = True #If you have trouble at KEEPALIVE1, turn this value to True
nic_name = '' #Indicate your nic, e.g. 'eth0.2'.nic_name
bind_ip = '172.21.133.102'
